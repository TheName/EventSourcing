...
namespace Bus.RabbitMQ.UnitTests.Factories
{
    public class RabbitMQChannelFactory_Should
    {
        [Theory]
        [AutoMoqData]
        internal void ReturnProperlyCreatedPublishingChannel(
            string exchangeName,
            string exchangeType,
            string queueName,
            string routingKey,
            ...
            RabbitMQChannelFactory channelFactory)
        {
            ...
            var channel = channelFactory.CreatePublishingChannel();
        ...
        [Theory]
        [AutoMoqData]
        internal void ReturnProperlyCreatedConsumingChannel(
            string exchangeName,
            string exchangeType,
            string queueName,
            string routingKey,
            ...
            RabbitMQChannelFactory channelFactory)
        {
            ...
            var channel = channelFactory.CreateConsumingChannel();
