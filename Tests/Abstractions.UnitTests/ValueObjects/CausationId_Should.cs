...
{
    public class CausationId_Should
    {
        [Fact]
        public void Throw_ArgumentException_When_CreatingWithEmptyGuid()
        {
            Assert.Throws<ArgumentException>(() => (CausationId) Guid.Empty);
        }
        ...
        {
            CausationId id1 = value;
            CausationId id2 = value;
        ...
        [Theory]
        [AutoMoqData]
        public void ReturnValueToString_When_CallingToString(CausationId id)
        {
